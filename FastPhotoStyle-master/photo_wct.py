...
class PhotoWCT(nn.Module):
    ...
    def transform(self, cont_img, styl_img, cont_seg, styl_seg):
        ...
        #print(cont_seg)
        csF4 = self.__feature_wct(cF4, sF4, cont_seg, styl_seg,4)
        ...
        csF3 = self.__feature_wct(cF3, sF3, cont_seg, styl_seg,3)
        ...
        csF2 = self.__feature_wct(cF2, sF2, cont_seg, styl_seg,2)
        Im2 = self.d2(csF2, cpool_idx, cpool)

        cF1 = self.e1(Im2)
        sF1 = sF1.data.squeeze(0)
        cF1 = cF1.data.squeeze(0)
        csF1 = self.__feature_wct(cF1, sF1, cont_seg, styl_seg,1)
        Im1 = self.d1(csF1)
        return Im1
...
#            print(target_feature)
            ...
            for l in self.label_set:
                ...
                if torch.__version__ >= "0.4.0":
                    ...
                    tmp_target_feature = cont_feat_rate*cFFG + (10-cont_feat_rate)*tmp_target_feature # 원본 : 변환 비율에 맞춰서 저장##############################################################
